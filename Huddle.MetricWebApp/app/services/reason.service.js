...
var ReasonService = /** @class */ (function () {
    ...
    ReasonService.prototype.addReason = function (reason) {
        ...
        var convertedReason = modelConverter_1.ModelConverter.ToReasonBackend(reason);
        this.dataService.post(constants_1.Constants.webAPI.reasonsUrl, { reason: convertedReason })
            .subscribe(function (resp) {
            activeObject.next(resp.reasonId);
        }, function (error) { return activeObject.error(error); });
        return activeObject;
    };
    ReasonService.prototype.editReason = function (reason) {
        var activeObject = new Rx_1.ReplaySubject(1);
        var convertedReason = modelConverter_1.ModelConverter.ToReasonBackend(reason);
        this.dataService.post(constants_1.Constants.webAPI.reasonEditUrl, { reason: convertedReason })
            .subscribe(function (resp) {
            activeObject.next(resp.reasonId);
        }, function (error) { return activeObject.error(error); });
        return activeObject;
    };
    ReasonService.prototype.getReasonById = function (id) {
        var activeObject = new Rx_1.ReplaySubject(1);
        this.dataService.getObject(constants_1.Constants.webAPI.reasonsUrl + "/" + id.toString())
    ...
    ReasonService.prototype.getReasonsByMetric = function (metricId) {
        var _this = this;
        var activeObject = new Rx_1.ReplaySubject(1);
        this.dataService.getArray(constants_1.Constants.webAPI.reasonsListUrl + "/" + metricId)
            .subscribe(function (resp) {
            var result = [];
    ...
    ReasonService.prototype.updateReasonStatus = function (reasonId) {
        this.dataService.post(constants_1.Constants.webAPI.reasonStatusUrl + "/" + reasonId, null);
    };
