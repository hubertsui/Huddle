...
var MetricValueService = /** @class */ (function () {
    ...
    MetricValueService.prototype.updateMetricValues = function (issueMetrics, reasonMetrics, jsonStr) {
        ...
        var originalIssueMetrics = originalData['issueWeekInputviewModel'].metricValueArray;
        var originalReasonMetrics = originalData['reasonWeekInputViewModelArray'].map(function (reasonWeekVM) { return reasonWeekVM.reasonValueArray; });
        var toPostIssueMetrics = issueMetrics.filter(function (metricValue, index) {
